...
from src.test.testplan import TestPlan
from src.test.testcases import TestCases
...
http_method = test_data["http_method"]
...
test_cases.create_test_cases(functionality_name, test_variables.variables, http_method, validation)
